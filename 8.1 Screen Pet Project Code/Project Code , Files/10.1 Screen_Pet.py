...
def toggle_eyes():
    ...
    current_state=c.itemcget(pupil_right,'state')
...
def toggle_pupils():
    if  not c.crossed_eyes:
        c.move(pupil_left,8,-3)
        c.move(pupil_right,-8,-3)
        c.crossed_eyes=True
    else:
        c.move(pupil_left,-8,3)
        c.move(pupil_right,8,3)
...
mouth_happy=c.create_line(170,250,200,285,230,250,smooth=1,width=2,state=HIDDEN)
